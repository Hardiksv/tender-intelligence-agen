...
class TenderExtractionSchema(BaseModel):
    ...
    emd_amount: Optional[float] = Field(default=None, description="Earnest Money Deposit (EMD) cumulative amount in INR.")
    emd_breakdown: Optional[dict[str, float]] = Field(default=None, description="Lot-wise or state-wise EMD breakdown in INR Crores.")
